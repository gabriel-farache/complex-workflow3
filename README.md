...
## Running complex.workflow3 in Quarkus dev mode
...
```
(complex.workflow3 should be included in the returned array)

Run the following to create an instance of the complex.workflow3 workflow:

```shell script
curl -XPOST -H "Content-Type: application/json" http://localhost:8080/complex.workflow3 -d@input.json
```
